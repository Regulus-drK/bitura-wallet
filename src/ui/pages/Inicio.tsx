...
import { consultarDireccion, enableMenu, getMnemonic, listarPrecios } from '../../services/apiService';
...
import { parseEthResponse, type EthResponse, type ParsedEthResponse } from '../../types/EthBalance';
